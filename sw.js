...
const CACHE = 'gains-shell-v44';
const SHELL = ['./', './index.html'];

self.addEventListener('install', e => {
  // cache:'reload' bypasses the browser's own HTTP cache on install, so a freshly
  // uploaded build is actually fetched rather than re-cached from a stale copy.
